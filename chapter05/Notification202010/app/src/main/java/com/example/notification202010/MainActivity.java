package com.example.notification202010;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void simpleNotify(){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            NotificationChannel notificationChannel =
                    new NotificationChannel("AppTestNotificationId", "AppTestNotificationName", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    private void mediaStyle(){
        Toast.makeText(getApplicationContext(),"暂未实现",Toast.LENGTH_LONG).show();
    }
}