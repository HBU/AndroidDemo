...
{
  /** Default implementation for IServicePlayer. */
  public static class Default implements com.androidbook.remoteservice.IServicePlayer
  {
  ...
  public static abstract class Stub extends android.os.Binder implements com.androidbook.remoteservice.IServicePlayer
  {
    private static final java.lang.String DESCRIPTOR = "com.androidbook.remoteservice.IServicePlayer";
    ...
    /**
     * Cast an IBinder object into an com.androidbook.remoteservice.IServicePlayer interface,
     * generating a proxy if needed.
     */
    public static com.androidbook.remoteservice.IServicePlayer asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.androidbook.remoteservice.IServicePlayer))) {
        return ((com.androidbook.remoteservice.IServicePlayer)iin);
      }
      return new com.androidbook.remoteservice.IServicePlayer.Stub.Proxy(obj);
    }
    ...
    private static class Proxy implements com.androidbook.remoteservice.IServicePlayer
    {
      ...
      @Override public boolean setLoop(boolean loop) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setLoop, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().setLoop(loop);
          }
          _reply.readException();
      ...
      public static com.androidbook.remoteservice.IServicePlayer sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(com.androidbook.remoteservice.IServicePlayer impl) {
    ...
    public static com.androidbook.remoteservice.IServicePlayer getDefaultImpl() {
